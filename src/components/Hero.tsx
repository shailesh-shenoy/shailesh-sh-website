...
export default function Hero() {
    ...
    return (
        <Stack as="section" p={8} w={"100%"} maxW="7xl" bgImage="/images/hero_blocks_dark.jpg" bgSize="cover" bgPosition="center" direction="column" align={{ md: "center" }} color="gray.50" border={2} borderStyle="solid" borderColor="#FF8066" minH="60vh" mt={16}>
            <ChakraText fontSize={{ base: "3xl", md: "5xl" }} lineHeight={1.2} initial={{ x: -1000 }} animate={{ x: 0 }} transition={{
                type: "spring",
                duration: "0.4",
                delay: "0"
            }}>
            ...
            <Heading as="h2" size="xl" mb={24} color={textColor} fontFamily="secondary">
            ...
            <Flex align="center" mt="auto">
                ...
                <Button as={NextLink} href="" variant="solid" fontSize="xl" border={1} borderStyle="solid" bg="#845EC2" _hover={{ bg: "#4B4453" }} color="white" borderColor="white" px={4} py={2} borderRadius={0}>Projects</Button>
            </Flex>
        </Stack>
    );
};
